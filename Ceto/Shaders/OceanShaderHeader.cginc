...
//proto mods
float3 Ceto_OilTint;
float3 OilPositionTest;

int numberOfOilStains = 65;
float oilStainMinimumRadius;//minRadius is where it will be completely the oil color
float oilStainMaximumRadius;//between min and Max radii, foam will mix with the oil according to a function; outside maxRadius, will be pure foam
float3 oilCenterPositions[300];
